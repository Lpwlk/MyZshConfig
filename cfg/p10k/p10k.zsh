...
# Generated by Powerlevel10k configuration wizard on 2023-06-07 at 02:05 CEST.
...
() {
  ...
  # The list of segments shown on the right. Fill it with less important segments. Right prompt on the last prompt line (where you are typing your commands) gets
  # automatically hidden when the input line reaches it. Right prompt above the last prompt line gets hidden if it would overlap with left prompt.
  ...
  typeset -g POWERLEVEL9K_UNUSED_PROMPT_ELEMENTS
...
######################################################################################################################################################
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%191F'  # green foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=191
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=68
  # Custom icon.
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=222
  # Custom icon.
...
#   typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%246Fwith '
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_FOREGROUND=111
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_INTERFACE} %069F$P9K_IP_IP'
  # typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_BYTES_DELTA:+%010F⇣$P9K_IP_RX_BYTES_DELTA }${P9K_IP_TX_BYTES_DELTA:+%009F⇡$P9K_IP_TX_BYTES_DELTA }%069F$P9K_IP_IP'
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=191
  # Show battery in yellow when it's discharging.
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=228
  # Battery pictograms going from low to high level of charge.
  typeset -g POWERLEVEL9K_BATTERY_STAGES='󰁺󰁻󰁼󰁽󰁾󰁿󰂀󰂁󰂂󰁹󰂄'
...
#   typeset -g POWERLEVEL9K_WIFI_VISUAL_IDENTIFIER_EXPANSION='⭐'
  ...
  #   # Wifi colors and icons for different signal strength levels (low to high).
    typeset -g my_wifi_fg=(10 20 30 40 50)                           # <-- change these values
    typeset -g my_wifi_icon=('WiFi' 'WiFi' 'WiFi' 'WiFi' 'WiFi')     # <-- change these values
  #
  typeset -g POWERLEVEL9K_WIFI_CONTENT_EXPANSION='%F{${my_wifi_fg[P9K_WIFI_BARS+1]}}%068F$P9K_WIFI_LAST_TX_RATE Mbps $P9K_WIFI_RSSI/$P9K_WIFI_NOISE dBm'
